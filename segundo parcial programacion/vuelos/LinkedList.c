...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
    	...
    	if (this->size == 0)
    	{
    		...
    		{
				NodoAux = getNode(this, (ll_len(this)-1));
				NodoAux->pNextNode = Nodo;
				Nodo->pNextNode = NULL;
				Nodo->pElement = pElement;
				this->size++;
    				...
    				switch(order)
    				{
						...
						case 0:// descendente
							...
							if( pFunc(pElement1,pElement2) == -1 )
							{
								...
								pElement_aux = pElement1;
								ll_set(this,i,pElement2);
								ll_set(this,j,pElement_aux);
							 	returnAux = 0;
...
LinkedList* ll_filter_parametro(LinkedList* this, int (*fn)(void* element,char* parametro),char* Str)
{
    LinkedList* lista = NULL;
